...
using uni.games.super_paper_mario;
...
[Verb("super_paper_mario",
      HelpText
          = "Export models en-masse from Super Paper Mario.")]
public sealed class SuperPaperMarioOptions
    : IMassExporterOptions<SuperPaperMarioMassExporter>;
