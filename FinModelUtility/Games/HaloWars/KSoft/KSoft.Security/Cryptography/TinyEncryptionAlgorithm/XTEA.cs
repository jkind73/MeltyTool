...
namespace KSoft.Security.Cryptography
{
		...
		: XTEABase
	{
		...
		protected override void EncryptBlock(byte[] input, byte[] output, int offset)
		{
			...
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k0;  z += (((y >> 5) ^ (y << 4)) + y) ^ this.k1;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k2;  z += (((y >> 5) ^ (y << 4)) + y) ^ this.k3;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k4;  z += (((y >> 5) ^ (y << 4)) + y) ^ this.k5;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k6;  z += (((y >> 5) ^ (y << 4)) + y) ^ this.k7;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k8;  z += (((y >> 5) ^ (y << 4)) + y) ^ this.k9;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k10; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k11;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k12; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k13;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k14; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k15;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k16; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k17;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k18; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k19;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k20; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k21;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k22; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k23;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k24; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k25;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k26; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k27;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k28; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k29;
			y += (((z << 4) ^ (z >> 5)) + z) ^ this.k30; z += (((y >> 5) ^ (y << 4)) + y) ^ this.k31;
