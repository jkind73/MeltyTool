...
namespace KSoft.Collections
{
		...
		where TEnum : struct, IComparable, IFormattable, IConvertible
	{
		...
		readonly BitSet mBits_;
		readonly TEnum mInvalidSentinelValue_;
		...
		public int Cardinality		{ get => this.mBits_.Cardinality; }
		/// <summary>Number of bits set to false</summary>
		public int CardinalityZeros	{ get => this.mBits_.CardinalityZeros; }

		/// <summary>Member or value to use when an operation results in an invalid value (eg, NextSetBit)</summary>
		public TEnum InvalidSentinelValue { get => this.mInvalidSentinelValue_; }
		...
		public EnumBitSet(TEnum invalidSentinelValue = default(TEnum))
		{
			...
			this.mBits_ = new BitSet(KBitSetLength);
			this.mInvalidSentinelValue_ = invalidSentinelValue;
		}
		#endregion
		...
		{
			get {
				int actualIndex = ToInt32(bitIndex);
				return this.mBits_[actualIndex];
			}
			set {
				int actualIndex = ToInt32(bitIndex);
				this.mBits_[actualIndex] = value;
			}
		}
		...
		{
			int actualIndex = ToInt32(bitIndex);
			this.mBits_.Toggle(actualIndex);
		}

		public void SetAll(bool value) => this.mBits_.SetAll(value);
		...
		{
			int actualIndex = ToInt32(startBitIndex);
			return this.mBits_.NextClearBitIndex(actualIndex);
		}
		...
		{
			int actualIndex = ToInt32(startBitIndex);
			return this.mBits_.NextSetBitIndex(actualIndex);
		}
		...
		{
			int bitIndex = this.NextClearBitIndex(startBitIndex);
			return bitIndex.IsNotNone()
				? FromInt32(bitIndex)
				: this.mInvalidSentinelValue_;
		}
		...
		{
			int bitIndex = this.NextSetBitIndex(startBitIndex);
			return bitIndex.IsNotNone()
				? FromInt32(bitIndex)
				: this.mInvalidSentinelValue_;
		}
		...
		public EnumeratorWrapper<TEnum, EnumeratorBitState> ClearBitIndices { get =>
			new EnumeratorWrapper<TEnum, EnumeratorBitState>(
				new EnumeratorBitState(this.mBits_.ClearBitIndices.GetEnumerator()));
		}
		...
		public EnumeratorWrapper<TEnum, EnumeratorBitState> SetBitIndices { get =>
			new EnumeratorWrapper<TEnum, EnumeratorBitState>(
				new EnumeratorBitState(this.mBits_.SetBitIndices.GetEnumerator()));
		}

		public EnumeratorBitState GetEnumerator() => new EnumeratorBitState(this.mBits_.SetBitIndices.GetEnumerator());
		IEnumerator<TEnum> IEnumerable<TEnum>.GetEnumerator() => new EnumeratorBitState(this.mBits_.SetBitIndices.GetEnumerator());
		System.Collections.IEnumerator System.Collections.IEnumerable.GetEnumerator() => new EnumeratorBitState(this.mBits_.SetBitIndices.GetEnumerator());
		#endregion
		...
		public EnumBitSet<TEnum> AndNot(EnumBitSet<TEnum> value)
		{
			...
			this.mBits_.AndNot(value.mBits_);
			return this;
		}
		...
		public void CopyTo(Array array, int arrayIndex) => (this.mBits_ as System.Collections.ICollection).CopyTo(array, arrayIndex);
		#endregion

		public void CopyTo(bool[] array, int arrayIndex) => this.mBits_.CopyTo(array, arrayIndex);
		...
		public override int GetHashCode()				=> this.mBits_.GetHashCode();
		#region IComparable<EnumBitSet<TEnum>> Members
		public int CompareTo(EnumBitSet<TEnum> other)	=> this.mBits_.CompareTo(other.mBits_);
		#endregion
		#region IEquatable<EnumBitSet<TEnum>> Members
		public bool Equals(EnumBitSet<TEnum> other)		=> this.mBits_.Equals(other.mBits_);
		#endregion

		public struct EnumeratorBitState
			: IEnumerator<TEnum>
		{
			StateFilterEnumerator mEnumerator_;

			public EnumeratorBitState(StateFilterEnumerator bitStateEnumerator)
			{
				this.mEnumerator_ = bitStateEnumerator;
			}

			public TEnum Current		{ get => FromInt32(this.mEnumerator_.Current); }
			object System.Collections.IEnumerator.Current { get => this.Current; }

			public bool MoveNext()		=> this.mEnumerator_.MoveNext();
			public void Reset()			=> this.mEnumerator_.Reset();

			public void Dispose()		=> this.mEnumerator_.Dispose();
		};

		#region IEndianStreamSerializable Members
		public void Serialize(IO.EndianStream s) => this.mBits_.Serialize(s);

		public void SerializeWords(IO.EndianStream s, Shell.EndianFormat streamedFormat = Bits.K_VECTOR_WORD_FORMAT) => this.mBits_.SerializeWords(s, streamedFormat);
		#endregion

		public void SerializeWords(IO.BitStream s, Shell.EndianFormat streamedFormat = Bits.K_VECTOR_WORD_FORMAT)
			=> this.mBits_.SerializeWords(s, streamedFormat);
	};
}
