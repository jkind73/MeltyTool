...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.4980392) + mergedLightDiffuseColor.rgb)*vec3(0.9686275)*texture(texture0.sampler, texture0.transform2d * vec3((uv0).x, (uv0).y, 1)).rgb;
