...
void main() {
  ...
  vec3 colorComponent = ((texture_3point(texture1, uv1).rgb + vec3(-1.0)*vec3(0.8431373))*vec3(0.4960938) + texture_3point(texture0, uv0).rgb)*mergedLightDiffuseColor.rgb;
