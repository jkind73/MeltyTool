...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.0971,0.0971,0.25)*vec3(0.2) + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.3882,0.3882,1.0);

  float alphaComponent = 0.502;
