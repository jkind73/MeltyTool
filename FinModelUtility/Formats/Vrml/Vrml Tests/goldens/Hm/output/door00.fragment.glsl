...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb*vec3(0.2) + mergedLightDiffuseColor.rgb)*vec3(0.8)*texture(texture0.sampler, texture0.transform2d * vec3((uv0).x, (uv0).y, 1)).rgb;
