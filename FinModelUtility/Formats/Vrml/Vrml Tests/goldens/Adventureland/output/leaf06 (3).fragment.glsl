...
void main() {
  ...
  vec3 colorComponent = (ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.501961)*texture(texture0, uv0).rgb;

  float alphaComponent = 0.47*texture(texture0, uv0).a;
