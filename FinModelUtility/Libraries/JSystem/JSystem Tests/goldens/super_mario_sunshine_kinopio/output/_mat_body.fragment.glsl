...
void main() {
  ...
  vec3 colorComponent = clamp(clamp(texture(texture0, uv0).rgb*(vec3(texture(texture1, uv1).a).g*65280.0 + vec3(texture(texture1, uv1).a).r*255.0 > 24575.62 ? vec3(1.0) : vec3(0.0)), 0.0, 1.0) + texture(texture2, uv1).rgb*(vec3(1.0) + vec3(-1.0)*(vec3(texture(texture1, uv1).a).g*65280.0 + vec3(texture(texture1, uv1).a).r*255.0 > 24575.62 ? vec3(1.0) : vec3(0.0))) + clamp((vec3(0.5) + texture(texture3, uv0).rgb*(vec3(1.0) + vec3(-1.0)*vec3(0.5)) + color_GxMaterialColor0*clamp((individualLightDiffuseColors[0].rgb + color_GxAmbientColor0), 0.0, 1.0)*vec3(0.5) + vec3(-0.5)), 0.0, 1.0)*(vec3(1.0) + vec3(-1.0)*vec3(0.2980392,0.4235294,0.3803922)) + color_GxMaterialColor0*clamp((individualLightDiffuseColors[2].rgb + clamp(color_GxAmbientColor1, 0.0, 1.0)), 0.0, 1.0)*vec3(0.2980392,0.4235294,0.3803922) + vec3(-0.5), 0.0, 1.0);
