...
void main() {
  ...
  vec3 colorComponent = (vec3(0.5019608)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.6509804)*vec3(0.3) + texture(texture0, sphericalReflectionUv).rgb*vec3(0.7);
