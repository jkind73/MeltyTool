...
void main() {
  ...
  vec3 colorComponent = ((vec3(0.5019608)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(0.7019608) + mergedLightSpecularColor.rgb)*texture(texture0, sphericalReflectionUv).rgb;
