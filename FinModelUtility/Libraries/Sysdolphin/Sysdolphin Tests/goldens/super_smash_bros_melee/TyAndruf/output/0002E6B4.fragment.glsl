...
void main() {
  ...
  vec3 colorComponent = (vec3(0.5019608)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*texture(texture0.sampler, transformUv3d(texture0.transform3d, uv0)).rgb;
