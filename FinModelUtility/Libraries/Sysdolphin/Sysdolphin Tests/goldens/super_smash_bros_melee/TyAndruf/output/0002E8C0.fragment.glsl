...
void main() {
  ...
  vec3 colorComponent = ((vec3(0.9529412,0.8509804,0.0)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.7019608,0.5019608,0.0) + vec3(1.0,1.0,0.5490196)*mergedLightSpecularColor.rgb)*vec3(0.5) + texture(texture0, sphericalReflectionUv).rgb*vec3(0.5);
