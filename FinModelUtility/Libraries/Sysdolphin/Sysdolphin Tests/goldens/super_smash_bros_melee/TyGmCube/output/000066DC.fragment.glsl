...
void main() {
  ...
  vec3 colorComponent = (vec3(0.0980392)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(0.2980392) + vec3(0.7647059,0.8,0.8)*mergedLightSpecularColor.rgb;
