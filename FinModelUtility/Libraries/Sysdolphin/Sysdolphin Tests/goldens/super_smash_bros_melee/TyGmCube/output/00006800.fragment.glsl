...
void main() {
  ...
  vec3 colorComponent = (vec3(0.6235294,0.2627451,0.1333333)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.8901961,0.3333333,0.1333333) + mergedLightSpecularColor.rgb;
