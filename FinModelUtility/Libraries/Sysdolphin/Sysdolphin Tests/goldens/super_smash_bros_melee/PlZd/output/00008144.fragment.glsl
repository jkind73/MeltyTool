...
void main() {
  ...
  vec3 colorComponent = (vec3(0.5019608,0.2980392,0.6)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb + mergedLightSpecularColor.rgb;
