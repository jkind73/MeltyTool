...
void main() {
  ...
  vec3 colorComponent = (vec3(0.7019608)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*texture(texture0, uv0).rgb + texture(texture1, uv1).rgb*mergedLightSpecularColor.rgb;
