...
void main() {
  ...
  vec3 colorComponent = ((vec3(0.3215686,0.3215686,0.345098)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(0.5294118,0.6313726,0.7568628) + vec3(0.8)*mergedLightSpecularColor.rgb)*texture(texture0, sphericalReflectionUv).rgb;
