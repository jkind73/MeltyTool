...
void main() {
  ...
  vec3 colorComponent = (vec3(0.7764706,0.7411765,0.7254902)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb + vec3(0.5019608)*mergedLightSpecularColor.rgb;
