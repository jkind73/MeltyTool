...
void main() {
  ...
  vec3 colorComponent = (vec3(0.1058824,0.027451,0.0)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(0.3333333,0.1647059,0.0) + vec3(0.4705882,0.2352941,0.0)*mergedLightSpecularColor.rgb;
