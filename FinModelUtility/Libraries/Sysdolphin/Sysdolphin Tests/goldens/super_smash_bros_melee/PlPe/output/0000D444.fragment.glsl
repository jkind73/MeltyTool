...
void main() {
  ...
  vec3 colorComponent = ((vec3(0.0980392)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(0.4117647,0.4117647,0.5647059) + vec3(0.9019608)*mergedLightSpecularColor.rgb)*texture(texture0, sphericalReflectionUv).rgb;
