...
void main() {
  ...
  vec3 colorComponent = (vec3(0.4392157,0.3803922,0.2352941)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*texture(texture0, uv0).rgb + vec3(0.6,0.6,0.5019608)*mergedLightSpecularColor.rgb;
