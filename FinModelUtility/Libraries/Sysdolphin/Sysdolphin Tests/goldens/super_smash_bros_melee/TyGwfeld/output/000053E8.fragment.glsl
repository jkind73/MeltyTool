...
void main() {
  ...
  vec3 colorComponent = (vec3(0.5019608,0.3803922,0.2)*ambientLightColor.rgb + mergedLightDiffuseColor.rgb)*vec3(2.0)*vec3(0.5019608,0.3803922,0.2);

  float alphaComponent = 0.6;
