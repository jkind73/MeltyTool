...
/// </summary>
[BinarySchema]
public sealed partial class AutoThruUnknownStringMagicUInt32SizedSection<T>
    : IMagicSection<T>
    where T : IBinaryConvertible, new() {
  private readonly PassThruUnknownStringMagicUInt32SizedSection<T> impl_ = new(new T());
