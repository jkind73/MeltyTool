...
public static class FtBitmapExtensions {
  ...
  public static Bitmap ToGdipBitmap(this FTBitmap b, Color color) {
    if (b.IsDisposed)
      throw new ObjectDisposedException("FTBitmap",
                                        "Cannot access a disposed object.");

    if (b.Width == 0 || b.Rows == 0)
      throw new InvalidOperationException(
          "Invalid image size - one or both dimensions are 0.");

    //TODO deal with negative pitch
    switch (b.PixelMode) {
      case PixelMode.Mono: {
        Bitmap bmp
            = new Bitmap(b.Width, b.Rows, PixelFormat.Format1bppIndexed);
        var locked = bmp.LockBits(new Rectangle(0, 0, b.Width, b.Rows),
      ...
      case PixelMode.Gray4: {
        Bitmap bmp
            = new Bitmap(b.Width, b.Rows, PixelFormat.Format4bppIndexed);
        var locked = bmp.LockBits(new Rectangle(0, 0, b.Width, b.Rows),
                                  ImageLockMode.ReadWrite,
      ...
      case PixelMode.Gray: {
        Bitmap bmp
            = new Bitmap(b.Width, b.Rows, PixelFormat.Format8bppIndexed);
        var locked = bmp.LockBits(new Rectangle(0, 0, b.Width, b.Rows),
                                  ImageLockMode.ReadWrite,
      ...
      case PixelMode.Lcd: {
        ...
        var locked = bmp.LockBits(new Rectangle(0, 0, bmpWidth, b.Rows),
                                  ImageLockMode.ReadWrite,
      ...
      default:
        throw new InvalidOperationException(
            "System.Drawing.Bitmap does not support this pixel mode.");
    }
  }
